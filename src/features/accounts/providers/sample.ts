...
const HARDCODED_PREVIOUS_MONTH: Omit<ConstructorParameters<typeof Transaction>[0], 'accountName'>[] = [
	...
	{ id: 'sample-prev-5', time: new Date(0), amount: 5000.00, vendor: 'Salary', category: 'Income', comment: 'Sample Transaction' },
]
...
const HARDCODED_CURRENT_MONTH: Omit<ConstructorParameters<typeof Transaction>[0], 'accountName'>[] = [
	...
	{ id: 'sample-curr-5', time: new Date(0), amount: 1200.00, vendor: 'Freelance', category: 'Income', comment: 'Sample Transaction' },
]
